        ...
        <div className={`flex-1 ${maxWidth}`}>
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full bg-muted text-foreground pl-10 md:pr-24 py-2 rounded-2xl border focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400"
                />
                {showShortcut && (
