...
import { getCoachBySlug, getCoachCourses } from "@/app/data/utils";
import { CourseCard } from "../components/course-card";
import { courseCategories } from "@/app/data/course-categories";
...
function ClassroomPage() {
  ...
  const allCourses = coach?.courseIds ? getCoachCourses(coach.id) : [];
