...
import { getCoachBySlug, getCoachProducts } from '@/app/coachme/data/utils';
import { products } from '@/app/coachme/data/products';
import Image from 'next/image';
import { Star, Download, FileText, Video, Book, Package, Ticket, Calendar } from 'lucide-react';
...
function ShopPage() {
    ...
    const allProducts = coach?.productIds
        ? getCoachProducts(coach.id)
        : [];
                        ...
                        <div key={category}>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                                {categoryProducts.map((product) => (
                                    <div
                                        key={product.id}
                                        onClick={() => router.push(`/coachme/${coachSlug}/product/${product.slug}`)}
