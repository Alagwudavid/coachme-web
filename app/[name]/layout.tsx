...
export default function CoachLayout({
    ...
    const tabs = [
        ...
        { id: 'classroom', label: 'Classroom', href: `/coachme/${coachSlug}/classroom` },
        { id: 'membership', label: 'Membership', href: `/coachme/${coachSlug}/membership` },
        { id: 'about', label: 'About', href: `/coachme/${coachSlug}/about` },
        { id: 'calendar', label: 'Calendar', href: `/coachme/${coachSlug}/calendar` },
    ];
