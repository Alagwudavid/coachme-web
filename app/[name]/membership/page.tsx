    ...
    <div className="space-y-8">
      ...
      <div className="text-center max-w-3xl mx-auto">
        ...
        <p className="text-lg text-muted-foreground">
          Join {coach?.name || "this coach"}'s community and unlock exclusive
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        {membershipTiers.map((tier) => (
          <div
            key={tier.id}
            className={`relative bg-card border-2 rounded-2xl p-8 transition-all hover:shadow-xl ${
              tier.popular
              ...
              {tier.features.map((feature, index) => (
                <li key={index} className="flex items-start gap-3">
                  <div className="mt-0.5 flex-shrink-0">
                    <div
                      className={`w-5 h-5 rounded-full bg-gradient-to-br ${tier.color} flex items-center justify-center`}
                    >
      ...
      <div className="max-w-3xl mx-auto bg-muted/50 rounded-2xl p-6">
        ...
        <p className="text-muted-foreground">
          Not sure which plan is right for you? Start with the Basic Membership
          and upgrade anytime. All plans include a 7-day money-back guarantee.
        </p>
      </div>
    </div>
  );
