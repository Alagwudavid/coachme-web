...
export default function Rightbar({ className }: RightbarProps) {
    ...
    return (
        <div className={`hidden lg:block lg:sticky lg:right-0 lg:top-0 lg:h-full lg:w-96 ${className} bg-background`}>
                 {/* Profile Banner */}
                 <div className="bg-muted flex flex-col w-full mx-auto relative rounded-2xl overflow-hidden">
                   <div className="w-full bg-sky-200 h-38 flex items-center justify-center"></div>
                 </div>
                 <div className="flex gap-6 bg-background p-4 pt-4 md:px-6 lg:px-8 -mt-14 lg:-mt-20">
                   <div className="rounded-full overflow-hidden w-20 h-20 md:w-25 md:h-25 z-10 mx-auto border-4 border-background">
                     {coach?.image ? (
                       <Image
                         src={coach.image}
