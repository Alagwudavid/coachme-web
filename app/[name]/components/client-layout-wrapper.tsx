      ...
      <div className="min-h-page w-full flex flex-col mx-auto">
        <main className="w-full mx-auto flex flex-col">
            <div className="flex flex-col w-full bg-background">
                ...
                <div className="rounded-full overflow-hidden w-30 h-30 md:w-37.5 md:h-37.5 z-10 -mt-14 lg:-mt-19 mx-auto border-4 border-background">
                  {coach?.image ? (
                    <Image
                      src={coach.image}
                ...
                {/* Profile Section */}
                <div className="max-w-5xl mx-auto flex gap-6 flex-col md:flex-row p-4 md:px-6 lg:px-8">
                    <div className="">
                        {/* Author Name */}
