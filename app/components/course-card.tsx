    ...
    return (
        ...
        >
                        ...
                        <div className="space-y-2 pt-4 border-t">
                            <div className="flex gap-4 text-foreground">
                                ...
                                <div className="flex flex-col text-foreground">
                                    ...
                                    <span className='text-sm text-muted-foreground'>Feb 07, 2026</span>
                                </div>
                            </div>
                            <div className="flex gap-4 text-foreground">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mt-1" width={24} height={24} viewBox="0 0 24 24"><g fill="none"><circle cx={12} cy={12} r={9} fill="currentColor" fillOpacity={0.25}></circle><path stroke="currentColor" strokeLinecap="round" d="M5 2.804A6 6 0 0 0 2.804 5M19 2.804A6 6 0 0 1 21.196 5M12 6.5v5.25c0 .138.112.25.25.25h4.25" strokeWidth={1}></path></g></svg>
                                <div className="flex flex-col text-foreground">
                                    <span>Time</span>
                                    <span className='text-sm text-muted-foreground'>09:00 AM - 11:30 AM EST(Africa/Lagos)</span>
                                </div>
                            </div>
                            <div className="flex gap-4 text-foreground">
                ...
                <div className="flex-1 flex flex-col space-y-1">
                    ...
                    <div className="flex items-center gap-1">
                        {[...Array(5)].map((_, i) => (
                            <svg
                                key={i}
                                className={`w-4 h-4 ${i < Math.floor(courseItem.rating)
                    ...
                    {(courseItem.price || courseItem.duration) && (
                        <div className="text-base font-semibold text-foreground">
                            {courseItem.price}{courseItem.duration && ` • ${courseItem.duration}`}
                        </div>
                    )}
                </div>
            </div>
            <div className='flex items-center gap-2 mt-1'>
                ...
                {courseItem.type && (
                    <div className={`px-2 py-1 rounded-full text-sm font-semibold flex items-center gap-1 bg-muted text-foreground`}>
                        {courseItem.type}
                    </div>
                )}
            </div>
